...
const recentCases = [
  { id: 1, title: "Student Union v. University Council", date: "Nov 14, 2023", category: "Constitutional" },
  { id: 2, title: "State v. Adebayo & Ors", date: "Nov 10, 2023", category: "Criminal" },
  { id: 3, title: "OAU Ventures v. Tech Corp", date: "Oct 28, 2023", category: "Commercial" },
];
              ...
              <FadeIn key={item.id} delay={index * 0.1} direction="up" className="h-full">
                <div className="group h-full bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-xl hover:border-[#002147] transition-all duration-300 cursor-pointer hover:-translate-y-1">
                  ...
                  <p className="text-sm text-gray-500 mb-4">
                    Detailed judgment regarding {item.category.toLowerCase()} matters...
                  </p>
